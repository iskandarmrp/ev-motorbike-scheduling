...
export function Dashboard() {
  ...
  const [activeAssignments, setActiveAssignments] = useState<Record<string, Assignment>>({})
    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-blue-600 text-white p-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {DEMO_MODE && <span className="text-xs bg-yellow-500 text-white px-2 py-1 rounded">DEMO MODE</span>}
      ...
      <main className="flex-1 p-4 flex flex-col gap-4">
        ...
        {DEMO_MODE && (
          <Alert>
            ...
            <AlertDescription>Running with mock data. Connect to a real backend server for live data.</AlertDescription>
          </Alert>
        )}

        <div className="h-[500px] bg-white rounded-lg shadow-md overflow-hidden">
          <MapContainer taxiStates={taxiStates} baseStates={baseStates} activeAssignments={activeAssignments} />
        </div>
        ...
        <Tabs defaultValue="taxis" className="bg-white rounded-lg shadow-md p-4">
          ...
          <TabsContent value="assignments">
            <AssignmentTable activeAssignments={activeAssignments} taxiStates={taxiStates} baseStates={baseStates} />
          </TabsContent>
